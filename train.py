...
gpu_id = 0
#feat_shape = (nz,)
#im_size = (1,image_size,image_size)
batch_size = 64
snapshot_at_iter = -1
...
for it in range(start_snapshot,max_iter):
  ...
  generator.net.blobs['label'].data[...] = data_reader.net.blobs['label'].data
  generator.net.forward_simple()
  generated_img = generator.net.blobs['generated_img'].data
...
#    generator.net.blobs['generated'].diff[...] = encoder.net.blobs['data'].diff + discriminator.net.blobs['data'].diff
    generator.net.blobs['generated_img'].diff[...] = discriminator.net.blobs['data'].diff
   # generator.net.blobs['mse_loss'].data[...] += 1e-03*discr_fake_for_generator_loss
